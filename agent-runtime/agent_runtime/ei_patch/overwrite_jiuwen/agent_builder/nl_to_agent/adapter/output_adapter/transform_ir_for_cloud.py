# @override(upstream) permanently overrides upstream agent_builder DSL model logic
...
# @override(jiuwen) removed model_config_llm constant
# @override(jiuwen)
...
class ConvertToEicloud:
    # @override(jiuwen) added model_dict parameter
    def __init__(self, original_data, plugin_dict, workflow_dict, model_dict):
        ...
        self.node_dict = {}
        # @override(jiuwen) added model_config_llm instance variable
        ...
        intent = NodeField(
            ...
            configs={
                "llm": {
                    ...
                    "temperature": 0.5,
                    "max_tokens": 2048,
                    # @override(jiuwen) changed model_config_llm to self.model_config_llm
