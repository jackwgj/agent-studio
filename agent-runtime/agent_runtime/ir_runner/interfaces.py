...
"""
ir_runner 接口定义 — ir_runner 消费但不在本模块实现的抽象契约。

实现类在 agentBuilder-engine 的 infrastructure 层提供：
- ObjectStorageProvider → runtime.storage.object_storage
- ModelConfigProvider   → runtime.ir_config.model_config
"""
...
class ObjectStorageProvider(ABC):
    ...
    IRWorkflowBuilder(storage_provider=...) 注入。
    """
