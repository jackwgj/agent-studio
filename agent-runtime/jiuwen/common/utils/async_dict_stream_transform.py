...
def _prune_none_fields(obj: Any) -> Any:  # noqa: return-statements-mismatch
    ...
    Notes:
        ...
        - Lists are kept as-is (items are still pruned if they are dicts). Unresolved placeholders in lists become None.
    """
...
class VariableDef:
    ...
    The variable is extracted from the input frame using src_path, and can optionally be accumulated (concat=True)
    so that the final frame can use the joined value.
    """
