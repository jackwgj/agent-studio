...
export const EditorVariableTree = createInjectMaterial(
  lazy(() => import('./extensions/variable-tree').then(module => ({ default: module.VariableTree }))),
  {
...
export const EditorVariableTagInject = createInjectMaterial(
  lazy(() => import('./extensions/variable-tag').then(module => ({ default: module.VariableTagInject }))),
  {
