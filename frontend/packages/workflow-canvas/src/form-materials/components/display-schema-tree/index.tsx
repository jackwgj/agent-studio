...
import { type IJsonSchema, type JsonSchemaTypeManager, useTypeManager } from '@flowgram.ai/json-schema'
...
function SchemaTree(props: PropsType) {
  ...
  let properties: IJsonSchema['properties'] = drilldown && config ? config.getTypeSchemaProperties(schema) : {}
