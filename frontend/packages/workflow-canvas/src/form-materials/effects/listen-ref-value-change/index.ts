...
import { BaseVariableField, DataEvent, Effect, EffectFuncProps, EffectOptions, getNodeScope } from '@flowgram.ai/editor'
 ...
 * @returns
 */
export const listenRefValueChange = (cb: (props: EffectFuncProps<IFlowRefValue> & { variable?: BaseVariableField }) => void): EffectOptions[] => [
  {
