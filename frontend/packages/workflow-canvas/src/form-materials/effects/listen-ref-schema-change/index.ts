...
import { BaseType, DataEvent, Effect, EffectFuncProps, EffectOptions, getNodeScope } from '@flowgram.ai/editor'
 ...
 * @returns
 */
export const listenRefSchemaChange = (cb: (props: EffectFuncProps<IFlowRefValue> & { schema?: IJsonSchema }) => void): EffectOptions[] => [
  {
