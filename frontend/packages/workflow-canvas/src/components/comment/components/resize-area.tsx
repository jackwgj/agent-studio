...
export const ResizeArea: FC<IResizeArea> = props => {
  ...
  const handleResizeStart = (startResizeEvent: React.MouseEvent | React.TouchEvent | MouseEvent) => {
    ...
    const { clientX: startX, clientY: startY } = MouseTouchEvent.getEventCoord(startResizeEvent as MouseEvent)
