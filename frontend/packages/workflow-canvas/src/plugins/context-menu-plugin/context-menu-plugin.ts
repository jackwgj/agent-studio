...
import { definePluginCreator, PluginCreator, FreeLayoutPluginContext } from '@flowgram.ai/free-layout-editor'
 ...
 */
export const createContextMenuPlugin: PluginCreator<ContextMenuPluginOptions> = definePluginCreator<ContextMenuPluginOptions, FreeLayoutPluginContext>({
  onInit(ctx, _options) {
