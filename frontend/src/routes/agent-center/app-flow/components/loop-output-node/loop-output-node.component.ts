...
@Component({
  selector: 'meta-loop-output-node',
  templateUrl: './loop-output-node.component.html',
  styleUrls: ['../common-styles.less', 'loop-output-node.component.less'],
  standalone: true,
...
export class LoopOutputNodeComponent
