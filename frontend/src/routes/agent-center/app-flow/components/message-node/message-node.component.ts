...
@Component({
  selector: 'meta-message-node',
  templateUrl: './message-node.component.html',
  styleUrls: ['../common-styles.less', './message-node.component.less'],
  standalone: true,
...
export class MessageNodeComponent extends NodeBaseComponent implements OnInit {
  @Input('nodeInfo') nodeInfo: IMessageNode;

  icon = WORKFLOW_SVGS.Message;
