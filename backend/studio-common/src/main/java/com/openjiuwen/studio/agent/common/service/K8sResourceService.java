...
public class K8sResourceService {
    ...
    private final Set<String> appLabels = Set.of("agent-base-rag","agent-base-runtime","jiuwen-runtime","agent-builder-agent-runtime","agent-ops","agentBuilder-code-interpreter","agent-builder-agent-manager");
    ...
    public double getAgentResourceCpu(CoreV1Api api) {
        ...
        try {
            ...
            for (V1Pod pod : podList.getItems()) {
                ...
                log.info("Get pod: {}, labels: {}", podName, labels);
                if (labels == null) {
                    continue;
                }
