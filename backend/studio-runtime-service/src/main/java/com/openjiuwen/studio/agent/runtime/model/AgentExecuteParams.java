...
public class AgentExecuteParams {
     ...
     * 敏感词匹配辅助
     */
    private SensitiveTrieUtils trieUtils;
    ...
    /**
     * 流式消息缓存：DeepResearch 场景下，每个流式消息都在内存中拼接完整再发送，sub_reporter节点每1000条拼接一次
     */
    @Builder.Default
    private Map<String, MessageChunkCache> messageChunkMap = new ConcurrentHashMap<>();
