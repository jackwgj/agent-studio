...
package com.openjiuwen.studio.agent.runtime.model.debugging.mapper;
...
import com.openjiuwen.studio.agent.runtime.dto.ControllerInvokeInfo;
...
import com.openjiuwen.studio.agent.runtime.dto.WorkflowBaseData;
...
import com.openjiuwen.studio.agent.runtime.model.debugging.ControllerExecutionInvokeModel;
...
public interface CtrlExecutionModelMapper {
    ...
    default WorkflowBaseData toWorkflowBaseData(String workflowId) {
        ...
        workflowBaseData.setWorkflowId(workflowId);
        return workflowBaseData;
    }
