...
import com.openjiuwen.studio.agent.runtime.dto.CommonDeleteRsp;
...
public interface TaskManagementApi {
    ...
    @RequestMapping(value = "/v1/{project_id}/workflows/{workflow_id}/tasks/{task_id}/cancel",
    ...
    @RequestMapping(value = "/v1/{project_id}/workflows/{workflow_id}/tasks", produces = {"application/json"},
    ...
    @RequestMapping(value = "/v1/{project_id}/workflows/{workflow_id}/tasks/{task_id}", produces = {"application/json"},
